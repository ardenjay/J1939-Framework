...
#define PCAN_ERROR_BUSLIGHT                                                    \
	0x00004U // Bus error: an error counter reached the 'light' limit
#define PCAN_ERROR_BUSHEAVY                                                    \
	0x00008U // Bus error: an error counter reached the 'heavy' limit
#define PCAN_ERROR_BUSWARNING                                                  \
	PCAN_ERROR_BUSHEAVY // Bus error: an error counter reached the 'warning'
						// limit
#define PCAN_ERROR_BUSPASSIVE                                                  \
	0x40000U // Bus error: the CAN controller is error passive
#define PCAN_ERROR_BUSOFF                                                      \
	0x00010U // Bus error: the CAN controller is in bus-off state
#define PCAN_ERROR_ANYBUSERR                                                   \
	(PCAN_ERROR_BUSWARNING | PCAN_ERROR_BUSLIGHT | PCAN_ERROR_BUSHEAVY |       \
...
#define PCAN_ERROR_REGTEST                                                     \
	0x00100U // Test of the CAN controller hardware registers failed (no
			 // hardware found)
...
#define PCAN_ERROR_ILLHANDLE                                                   \
	(PCAN_ERROR_ILLHW | PCAN_ERROR_ILLNET |                                    \
	 PCAN_ERROR_ILLCLIENT) // Mask for all handle errors
#define PCAN_ERROR_RESOURCE                                                    \
	0x02000U // Resource (FIFO, Client, timeout) cannot be created
...
#define PCAN_ERROR_CAUTION                                                     \
	0x2000000U // An operation was successfully carried out, however,
			   // irregularities were registered
#define PCAN_ERROR_INITIALIZE                                                  \
	0x4000000U // Channel is not initialized [Value was changed from 0x40000 to
			   // 0x4000000]
#define PCAN_ERROR_ILLOPERATION                                                \
	0x8000000U // Invalid operation [Value was changed from 0x80000 to
			   // 0x8000000]
...
#define PCAN_PEAKCAN                                                           \
	0x01U // PCAN Non-Plug&Play devices. NOT USED WITHIN PCAN-Basic API
#define PCAN_ISA 0x02U // PCAN-ISA, PCAN-PC/104, and PCAN-PC/104-Plus
#define PCAN_DNG 0x03U // PCAN-Dongle
#define PCAN_PCI                                                               \
	0x04U // PCAN-PCI, PCAN-cPCI, PCAN-miniPCI, and PCAN-PCI Express
#define PCAN_USB 0x05U // PCAN-USB and PCAN-USB Pro
#define PCAN_PCC 0x06U // PCAN-PC Card
#define PCAN_VIRTUAL                                                           \
	0x07U			   // PCAN Virtual hardware. NOT USED WITHIN PCAN-Basic API
...
#define PCAN_LOG_CONFIGURE                                                     \
	0x0BU // Configuration of the debugged information (LOG_FUNCTION_***)
...
#define PCAN_TRACE_SIZE                                                        \
	0x13U // Configuration of the maximum file size of a CAN trace
#define PCAN_TRACE_CONFIGURE                                                   \
	0x14U // Configuration of the trace file storing mode (TRACE_FILE_***)
#define PCAN_CHANNEL_IDENTIFYING                                               \
	0x15U // Physical identification of a USB based PCAN-Channel by blinking its
		  // associated LED
#define PCAN_CHANNEL_FEATURES                                                  \
	0x16U // Capabilities of a PCAN device (FEATURE_***)
...
#define PCAN_BITRATE_INFO_FD                                                   \
	0x19U // Configured bit rate as TPCANBitrateFD string
#define PCAN_BUSSPEED_NOMINAL                                                  \
	0x1AU // Configured nominal CAN Bus speed as Bits per seconds
#define PCAN_BUSSPEED_DATA                                                     \
	0x1BU // Configured CAN data speed as Bits per seconds
#define PCAN_IP_ADDRESS                                                        \
	0x1CU // Remote address of a LAN channel as string in IPv4 format
#define PCAN_LAN_SERVICE_STATUS                                                \
	0x1DU // Status of the Virtual PCAN-Gateway Service
#define PCAN_ALLOW_STATUS_FRAMES                                               \
	0x1EU // Status messages reception status within a PCAN-Channel
#define PCAN_ALLOW_RTR_FRAMES                                                  \
	0x1FU // RTR messages reception status within a PCAN-Channel
#define PCAN_ALLOW_ERROR_FRAMES                                                \
	0x20U // Error messages reception status within a PCAN-Channel
#define PCAN_INTERFRAME_DELAY                                                  \
	0x21U // Delay, in microseconds, between sending frames
...
#define PCAN_FILTER_CLOSE                                                      \
	0x00U // The PCAN filter is closed. No messages will be received
#define PCAN_FILTER_OPEN                                                       \
	0x01U // The PCAN filter is fully opened. All messages will be received
#define PCAN_FILTER_CUSTOM                                                     \
	0x02U // The PCAN filter is custom configured. Only registered messages will
		  // be received
#define PCAN_CHANNEL_UNAVAILABLE                                               \
	0x00U // The PCAN-Channel handle is illegal, or its associated hardware is
		  // not available
#define PCAN_CHANNEL_AVAILABLE                                                 \
	0x01U // The PCAN-Channel handle is available to be connected (Plug&Play
		  // Hardware: it means furthermore that the hardware is plugged-in)
#define PCAN_CHANNEL_OCCUPIED                                                  \
	0x02U // The PCAN-Channel handle is valid, and is already being used
#define PCAN_CHANNEL_PCANVIEW                                                  \
	(PCAN_CHANNEL_AVAILABLE |                                                  \
	 PCAN_CHANNEL_OCCUPIED) // The PCAN-Channel handle is already being used by
							// a PCAN-View application, but is available to
							// connect

#define LOG_FUNCTION_DEFAULT 0x00U // Logs system exceptions / errors
#define LOG_FUNCTION_ENTRY                                                     \
	0x01U // Logs the entries to the PCAN-Basic API functions
#define LOG_FUNCTION_PARAMETERS                                                \
	0x02U // Logs the parameters passed to the PCAN-Basic API functions
#define LOG_FUNCTION_LEAVE                                                     \
	0x04U // Logs the exits from the PCAN-Basic API functions
#define LOG_FUNCTION_WRITE                                                     \
	0x08U // Logs the CAN messages passed to the CAN_Write function
#define LOG_FUNCTION_READ                                                      \
	0x10U // Logs the CAN messages received within the CAN_Read function
#define LOG_FUNCTION_ALL                                                       \
	0xFFFFU // Logs all possible information within the PCAN-Basic API functions

#define TRACE_FILE_SINGLE                                                      \
	0x00U // A single file is written until it size reaches PAN_TRACE_SIZE
#define TRACE_FILE_SEGMENTED                                                   \
	0x01U // Traced data is distributed in several files with size
		  // PAN_TRACE_SIZE
#define TRACE_FILE_DATE                                                        \
	0x02U // Includes the date into the name of the trace file
#define TRACE_FILE_TIME                                                        \
	0x04U // Includes the start time into the name of the trace file
...
#define FEATURE_DELAY_CAPABLE                                                  \
	0x02U // Device supports a delay between sending frames (FPGA based USB
		  // devices)
...
// Total Microseconds = micros + 1000 * millis + 0xFFFFFFFF * 1000 *
// millis_overflow
...
typedef TPCANStatus (*CAN_InitializePtr)(TPCANHandle, TPCANBaudrate, TPCANType,
										 u32, u16);
...
typedef TPCANStatus (*CAN_GetValuePtr)(TPCANHandle, TPCANParameter, void *,
									   u32);
typedef TPCANStatus (*CAN_SetValuePtr)(TPCANHandle, TPCANParameter, void *,
									   u32);
